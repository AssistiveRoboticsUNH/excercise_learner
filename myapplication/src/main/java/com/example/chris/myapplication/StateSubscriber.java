...
//                    }
        ...
        Subscriber<std_msgs.Int32> n_repeatsSubscriber = connectedNode.newSubscriber("/exercise/n_repeats", std_msgs.Int32._TYPE);
        n_repeatsSubscriber.addMessageListener(new MessageListener<std_msgs.Int32>() {
            @Override
            public void onNewMessage (final std_msgs.Int32 msg) {
